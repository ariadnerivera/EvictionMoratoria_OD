...
a <- names(df[, paste0("LiftMoratoria", 2:20)])
...
allvars <- list(trt = 
                  list(c(paste0(statebaseline, rep("2", 11)), paste0(statetimevarying, rep("1", 4)), paste0(outcomestate, "1")),
                       ...
                       c(paste0(statebaseline, rep("7", 11)), paste0(statetimevarying, rep("6", 4)), paste0(outcomestate, "6"), paste0(CDC_moratoria, "6")),
                       c(paste0(statebaseline, rep("8", 11)), paste0(statetimevarying, rep("7", 4)), paste0(outcomestate, "7"), paste0(CDC_moratoria, "7")),
                       c(paste0(statebaseline, rep("9", 11)), paste0(statetimevarying, rep("8", 4)), paste0(outcomestate, "8"), paste0(CDC_moratoria, "8")),
                       c(paste0(statebaseline, rep("10", 11)), paste0(statetimevarying, rep("9", 4)), paste0(outcomestate, "9"), paste0(CDC_moratoria, "9")),
                       c(paste0(statebaseline, rep("11", 11)), paste0(statetimevarying, rep("10", 4)), paste0(outcomestate, "10"), paste0(CDC_moratoria, "10"), paste0(statevaccines, "10")),
                       c(paste0(statebaseline, rep("12", 11)), paste0(statetimevarying, rep("11", 4)), paste0(outcomestate, "11"), paste0(CDC_moratoria, "11"), paste0(statevaccines, "11")),
                       c(paste0(statebaseline, rep("13", 11)), paste0(statetimevarying, rep("12", 4)), paste0(outcomestate, "12"), paste0(CDC_moratoria, "12"), paste0(statevaccines, "12")),
                       c(paste0(statebaseline, rep("14", 11)), paste0(statetimevarying, rep("13", 4)), paste0(outcomestate, "13"), paste0(CDC_moratoria, "13"), paste0(statevaccines, "13")),
                       c(paste0(statebaseline, rep("15", 11)), paste0(statetimevarying, rep("14", 4)), paste0(outcomestate, "14"), paste0(CDC_moratoria, "14"), paste0(statevaccines, "14")),
                       c(paste0(statebaseline, rep("16", 11)), paste0(statetimevarying, rep("15", 4)), paste0(outcomestate, "15"), paste0(CDC_moratoria, "15"), paste0(statevaccines, "15")),
                ...
                outcome =
                  list(c(paste0(ctybaseline, rep("2", 24)), paste0(ctytimevarying, rep("1", 5)), paste0(outcomecty, "1")),
                       ...
                       c(paste0(ctybaseline, rep("7", 24)), paste0(ctytimevarying, rep("6", 5)), paste0(outcomecty, "6"), paste0(CDC_moratoria, "6")),
                       c(paste0(ctybaseline, rep("8", 24)), paste0(ctytimevarying, rep("7", 5)), paste0(outcomecty, "7"), paste0(CDC_moratoria, "7")),
                       c(paste0(ctybaseline, rep("9", 24)), paste0(ctytimevarying, rep("8", 5)), paste0(outcomecty, "8"), paste0(CDC_moratoria, "8")),
                       c(paste0(ctybaseline, rep("10", 24)), paste0(ctytimevarying, rep("9", 5)), paste0(outcomecty, "9"), paste0(CDC_moratoria, "9")),
                       c(paste0(ctybaseline, rep("11", 24)), paste0(ctytimevarying, rep("10", 5)), paste0(outcomecty, "10"), paste0(CDC_moratoria, "10"), paste0(ctyvaccines, "10")),
                       c(paste0(ctybaseline, rep("12", 24)), paste0(ctytimevarying, rep("11", 5)), paste0(outcomecty, "11"), paste0(CDC_moratoria, "11"), paste0(ctyvaccines, "11")),
                       c(paste0(ctybaseline, rep("13", 24)), paste0(ctytimevarying, rep("12", 5)), paste0(outcomecty, "12"), paste0(CDC_moratoria, "12"), paste0(ctyvaccines, "12")),
                       c(paste0(ctybaseline, rep("14", 24)), paste0(ctytimevarying, rep("13", 5)), paste0(outcomecty, "13"), paste0(CDC_moratoria, "13"), paste0(ctyvaccines, "13")),
                       c(paste0(ctybaseline, rep("15", 24)), paste0(ctytimevarying, rep("14", 5)), paste0(outcomecty, "14"), paste0(CDC_moratoria, "14"), paste0(ctyvaccines, "14")),
                       c(paste0(ctybaseline, rep("16", 24)), paste0(ctytimevarying, rep("15", 5)), paste0(outcomecty, "15"), paste0(CDC_moratoria, "15"), paste0(ctyvaccines, "15")),
                       c(paste0(ctybaseline, rep("17", 24)), paste0(ctytimevarying, rep("16", 5)), paste0(outcomecty, "16"), paste0(CDC_moratoria, "16"), paste0(ctyvaccines, "16")),
...
########################################################################
#Repeat but for shifted df

#load dataset
mtpdata <- read_dta("data/analysis_county_march2020_dec2021_mtp.dta")

mtpdata <- mtpdata %>% rename(StringencyIndex = StringencyIndex_Average,
                        GovernmentResponseIndex = GovernmentResponseIndex_Average,
                        ContainmentHealthIndex = ContainmentHealthIndex_Average)
...
mtpdata2 <- mtpdata[myvars]

mtpdata2 <- mtpdata2[order(mtpdata2$geofips, mtpdata2$YearMonth),]

mtpdata2$intercept <- 1
...
startTime
with_progress(psi.tmle.mtp.county.allvars_updated.shift <- lmtp_tmle(df, trt = a,
...
saveRDS(psi.tmle.mtp.county.allvars_updated.shift, "results/manuscript_updated/mtp/shift_tmle_mtp_20240530.rds")

startTime2 <- Sys.time() 

with_progress(psi.tmle.mtp.county.allvars_updated.ref <- lmtp_tmle(df, trt = a,
                                                                   outcome="cumodratemon21",
                                                                   time_vary=allvars,
                                                                   cens = NULL,
                                                                   shift = NULL,
...
saveRDS(psi.tmle.mtp.county.allvars_updated.ref, "results/manuscript_updated/mtp/ref_tmle_mtp_20240530.rds")
...
startTime <- Sys.time() 
startTime
with_progress(psi.sdr.mtp.county.allvars_updated.shift <- lmtp_sdr(df, trt = a,
                                                                   outcome="cumodratemon21",
                                                                   time_vary=allvars,
                                                                   cens = NULL,
                                                                   shift = NULL,
...
saveRDS(psi.sdr.mtp.county.allvars_updated.shift, "results/manuscript_updated/mtp/shift_sdr_mtp_20240530.rds")

startTime2 <- Sys.time() 

with_progress(psi.sdr.mtp.county.allvars_updated.ref <- lmtp_sdr(df, trt = a,
                                                                 outcome="cumodratemon21",
                                                                 time_vary=allvars,
                                                                 cens = NULL,
                                                                 shift = NULL,
...
saveRDS(psi.sdr.mtp.county.allvars_updated.ref, "results/manuscript_updated/mtp/ref_sdr_mtp_20240530.rds")