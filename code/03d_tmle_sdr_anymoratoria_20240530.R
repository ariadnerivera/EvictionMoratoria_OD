...
startTime <- Sys.time() 
startTime
with_progress(psi.tmle.mtp.county.anymoratoria_updated.shift <- lmtp_tmle(df, trt = a,
...
saveRDS(psi.tmle.mtp.county.anymoratoria_updated.shift, "results/manuscript_updated/anymoratoria/shift_tmle_anymoratoria_20240530.rds")

startTime2 <- Sys.time() 

with_progress(psi.tmle.mtp.county.anymoratoria_updated.ref <- lmtp_tmle(df, trt = a,
                                                                   outcome="cumodratemon21",
                                                                   time_vary=allvars,
                                                                   cens = NULL,
...
saveRDS(psi.tmle.mtp.county.anymoratoria_updated.ref, "results/manuscript_updated/anymoratoria/ref_tmle_anymoratoria_20240530.rds")
...
startTime <- Sys.time() 
startTime
with_progress(psi.sdr.mtp.county.anymoratoria_updated.shift <- lmtp_sdr(df, trt = a,
                                                                   outcome="cumodratemon21",
                                                                   time_vary=allvars,
                                                                   cens = NULL,
                                                                   shift = static_binary_on,
...
saveRDS(psi.sdr.mtp.county.anymoratoria_updated.shift, "results/manuscript_updated/anymoratoria/shift_sdr_anymoratoria_20240530.rds")

startTime2 <- Sys.time() 

with_progress(psi.sdr.mtp.county.anymoratoria_updated.ref <- lmtp_sdr(df, trt = a,
                                                                 outcome="cumodratemon21",
                                                                 time_vary=allvars,
                                                                 cens = NULL,
                                                                 shift = static_binary_off,
...
saveRDS(psi.sdr.mtp.county.anymoratoria_updated.ref, "results/manuscript_updated/anymoratoria/ref_sdr_anymoratoria_20240530.rds")
