...
a <- names(df[, paste0("LiftMoratoria", 5:20)])
...
allvars <- list(trt = 
                  list(c(paste0(statebaseline, rep("5", 11)), paste0(statetimevarying, rep("4", 4)), paste0(outcomestate, "4")),
                ...
                outcome =
                  list(c(paste0(ctybaseline, rep("5", 24)), paste0(ctytimevarying, rep("4", 5)), paste0(outcomecty, "4")),
...
saveRDS(psi.tmle.mtp.county.allvars_updated.shift, "results/manuscript_updated/tertiles/shift_3tertile.rds")
...
saveRDS(psi.tmle.mtp.county.allvars_updated.ref, "results/manuscript_updated/tertiles/ref_3tertile.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.shift, "results/manuscript_updated/tertiles/shift_3tertile_sdr.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.ref, "results/manuscript_updated/tertiles/ref_3tertile_sdr.rds")
