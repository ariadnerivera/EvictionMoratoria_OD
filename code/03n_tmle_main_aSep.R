...
# This code runs analysis for ATE, for states that lifted after September
...
myvars <- c("geofips", "StateFIPS", "StateAbbreviation", 
            "Year", "YearMonth", "MonthNum", 
...
df <- df[df$StateAbbreviation %in% afterSep, ]
...
a <- names(df[, paste0("LiftMoratoriaObin", 6:20)])
...
# Confounder sets
mytimevary <- list(trt =
                     list(c(paste0(statedemographic, rep("6")), paste0(statetimevarying, rep("5")), paste0(outcomestate, "5")),
                   ...
                   outcome =
                     list(c(paste0(ctydemographic, rep("6")), paste0(ctytimevarying, rep("5")), paste0(outcomecty, "5")),
