...
saveRDS(psi.tmle.mtp.county.allvars_updated.shift, "results/manuscript_updated/main/shift_tmle_main_20240530.rds")
...
saveRDS(psi.tmle.mtp.county.allvars_updated.ref, "results/manuscript_updated/main/ref_tmle_main_20240530.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.shift, "results/manuscript_updated/main/shift_sdr_main_20240530.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.ref, "results/manuscript_updated/main/ref_sdr_main_20240530.rds")
