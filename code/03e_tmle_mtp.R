...
# This code runs analysis for mtp, fully adjusted
model_type <- "mtp"
...
# State-level monthly covariates
statetimevarying <- c(
  "covidratenew_state",
...
## Monthly county-level covariates
ctytimevarying <- c(
  "covidratenew",
  "coviddeathratenew",
  "ContainmentHealthIndex",
...
datamtp <- datamtp %>% rename(StringencyIndex = StringencyIndex_Average,
                        GovernmentResponseIndex = GovernmentResponseIndex_Average,
                        ContainmentHealthIndex = ContainmentHealthIndex_Average)


datamtp2 <- datamtp[myvars]

datamtp2 <- datamtp2[order(datamtp2$geofips, datamtp2$YearMonth),]
