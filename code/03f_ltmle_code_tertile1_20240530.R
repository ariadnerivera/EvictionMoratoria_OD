...
saveRDS(psi.tmle.mtp.county.allvars_updated.shift, "results/manuscript_updated/tertiles/shift_1tertile.rds")
...
saveRDS(psi.tmle.mtp.county.allvars_updated.ref, "results/manuscript_updated/tertiles/ref_1tertile.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.shift, "results/manuscript_updated/tertiles/shift_1tertile_sdr.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.ref, "results/manuscript_updated/tertiles/ref_1tertile_sdr.rds")


lmtp_contrast(psi.sdr.mtp.county.allvars_updated.shift, ref = psi.sdr.mtp.county.allvars_updated.ref)
...
saveRDS(psi.tmle.mtp.county.allvars_updated.shift, "results/manuscript_updated/tertiles/shift_1tertile_unadj.rds")
...
saveRDS(psi.tmle.mtp.county.allvars_updated.ref, "results/manuscript_updated/tertiles/ref_1tertile_unadj.rds")
