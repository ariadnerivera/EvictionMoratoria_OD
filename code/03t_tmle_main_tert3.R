...
# This code runs analysis for ATE, states in tertile 3
model_type <- "tert3"
...
#Rescrict to first tertile
datatertile3 <- data[ which(data$elrating_tertile==3), ]
...
a <- names(df[, paste0("LiftMoratoriaObin", 5:20)])
...
## Annual county-level demographic data
ctydemographic <- c(
  "popdensity",
  "mhhinc",
  "gini",
...
# Confounder sets
mytimevary <- list(trt =
                     list(c(paste0(statedemographic, rep("5")), paste0(statetimevarying, rep("4")), paste0(outcomestate, "4")),
                          c(paste0(statedemographic, rep("6")), paste0(statetimevarying, rep("5")), paste0(outcomestate, "5")),
                          c(paste0(statedemographic, rep("7")), paste0(statetimevarying, rep("6")), paste0(outcomestate, "6"), paste0(CDC_moratoria, "6")),
                          c(paste0(statedemographic, rep("8")), paste0(statetimevarying, rep("7")), paste0(outcomestate, "7"), paste0(CDC_moratoria, "7")),
                          c(paste0(statedemographic, rep("9")), paste0(statetimevarying, rep("8")), paste0(outcomestate, "8"), paste0(CDC_moratoria, "8")),
                          c(paste0(statedemographic, rep("10")), paste0(statetimevarying, rep("9")), paste0(outcomestate, "9"), paste0(CDC_moratoria, "9")),
                          c(paste0(statedemographic, rep("11")), paste0(statetimevarying, rep("10")), paste0(outcomestate, "10"), paste0(CDC_moratoria, "10"), paste0(statevaccines, "10")),
                          c(paste0(statedemographic, rep("12")), paste0(statetimevarying, rep("11")), paste0(outcomestate, "11"), paste0(CDC_moratoria, "11"), paste0(statevaccines, "11")),
                          c(paste0(statedemographic, rep("13")), paste0(statetimevarying, rep("12")), paste0(outcomestate, "12"), paste0(CDC_moratoria, "12"), paste0(statevaccines, "12")),
                          c(paste0(statedemographic, rep("14")), paste0(statetimevarying, rep("13")), paste0(outcomestate, "13"), paste0(CDC_moratoria, "13"), paste0(statevaccines, "13")),
                          c(paste0(statedemographic, rep("15")), paste0(statetimevarying, rep("14")), paste0(outcomestate, "14"), paste0(CDC_moratoria, "14"), paste0(statevaccines, "14")),
                          c(paste0(statedemographic, rep("16")), paste0(statetimevarying, rep("15")), paste0(outcomestate, "15"), paste0(CDC_moratoria, "15"), paste0(statevaccines, "15")),
                          c(paste0(statedemographic, rep("17")), paste0(statetimevarying, rep("16")), paste0(outcomestate, "16"), paste0(CDC_moratoria, "16"), paste0(statevaccines, "16")),
                   ...
                   cens = c(lapply(1:16, function(x) NULL)),
                   outcome =
                     list(c(paste0(ctydemographic, rep("5")), paste0(ctytimevarying, rep("4")), paste0(outcomecty, "4")),
                          c(paste0(ctydemographic, rep("6")), paste0(ctytimevarying, rep("5")), paste0(outcomecty, "5")),
                          c(paste0(ctydemographic, rep("7")), paste0(ctytimevarying, rep("6")), paste0(outcomecty, "6"), paste0(CDC_moratoria, "6")),
                          c(paste0(ctydemographic, rep("8")), paste0(ctytimevarying, rep("7")), paste0(outcomecty, "7"), paste0(CDC_moratoria, "7")),
                          c(paste0(ctydemographic, rep("9")), paste0(ctytimevarying, rep("8")), paste0(outcomecty, "8"), paste0(CDC_moratoria, "8")),
                          c(paste0(ctydemographic, rep("10")), paste0(ctytimevarying, rep("9")), paste0(outcomecty, "9"), paste0(CDC_moratoria, "9")),
                          c(paste0(ctydemographic, rep("11")), paste0(ctytimevarying, rep("10")), paste0(outcomecty, "10"), paste0(CDC_moratoria, "10"), paste0(ctyvaccines, "10")),
                          c(paste0(ctydemographic, rep("12")), paste0(ctytimevarying, rep("11")), paste0(outcomecty, "11"), paste0(CDC_moratoria, "11"), paste0(ctyvaccines, "11")),
                          c(paste0(ctydemographic, rep("13")), paste0(ctytimevarying, rep("12")), paste0(outcomecty, "12"), paste0(CDC_moratoria, "12"), paste0(ctyvaccines, "12")),
                          c(paste0(ctydemographic, rep("14")), paste0(ctytimevarying, rep("13")), paste0(outcomecty, "13"), paste0(CDC_moratoria, "13"), paste0(ctyvaccines, "13")),
                          c(paste0(ctydemographic, rep("15")), paste0(ctytimevarying, rep("14")), paste0(outcomecty, "14"), paste0(CDC_moratoria, "14"), paste0(ctyvaccines, "14")),
                          c(paste0(ctydemographic, rep("16")), paste0(ctytimevarying, rep("15")), paste0(outcomecty, "15"), paste0(CDC_moratoria, "15"), paste0(ctyvaccines, "15")),
                          c(paste0(ctydemographic, rep("17")), paste0(ctytimevarying, rep("16")), paste0(outcomecty, "16"), paste0(CDC_moratoria, "16"), paste0(ctyvaccines, "16")),
...
mybaseline <- list(
  ...
  cens = NULL,
  outcome = c("pct_repvotes2016", "pct_demvotes2016", "metro")
)
