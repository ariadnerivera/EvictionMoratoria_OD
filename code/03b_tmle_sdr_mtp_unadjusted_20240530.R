...
saveRDS(psi.tmle.mtp.county.allvars_updated.shift, "results/manuscript_updated/mtp_unadjusted/shift_tmle_mtp_20240530.rds")
...
saveRDS(psi.tmle.mtp.county.allvars_updated.ref, "results/manuscript_updated/mtp_unadjusted/ref_tmle_mtp_20240530.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.shift, "results/manuscript_updated/mtp_unadjusted/shift_sdr_mtp_20240530.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.ref, "results/manuscript_updated/mtp_unadjusted/ref_sdr_mtp_20240530.rds")