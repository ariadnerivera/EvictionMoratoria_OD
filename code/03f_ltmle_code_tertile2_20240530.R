...
saveRDS(psi.tmle.mtp.county.allvars_updated.shift, "results/manuscript_updated/tertiles/shift_2tertile.rds")
...
saveRDS(psi.tmle.mtp.county.allvars_updated.ref, "results/manuscript_updated/tertiles/ref_2tertile.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.shift, "results/manuscript_updated/tertiles/shift_2tertile_sdr.rds")
...
saveRDS(psi.sdr.mtp.county.allvars_updated.ref, "results/manuscript_updated/tertiles/ref_2tertile_sdr.rds")
